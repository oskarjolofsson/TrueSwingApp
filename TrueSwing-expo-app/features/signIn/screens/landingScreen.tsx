...
export default function LandingScreen({ onGoogleButtonPress, onEmailButtonPress, onAppleButtonPress, submitting, error }: Props) {
                ...
                <View className="">
                    ...
                    >
                        <View
                            ...
                            style={{ backgroundColor: "#f1f3f4" }}
                        >
                            <FontAwesome name="apple" size={18} color="#4285F4" />
                        </View>
                        <Text
                            style={{
                                color: "#111111",
